...
a.querySelectorAll("*"):[];-1!==["SELECT","INPUT","TEXTAREA","CHECKBOX","RADIOBUTTON"].indexOf(a.tagName)&&(b=!0);!b&&[].forEach.call(c,function(a){-1!==["SELECT","INPUT","TEXTAREA","CHECKBOX","RADIOBUTTON"].indexOf(a.tagName)&&(b=!0)})});b&&d.reload()}})})).observe(this.formHandle,{childList:!0,subtree:!0});return this};m.prototype={messages:{en:{password:{empty: 'S\'il vous plaît, entrez votre mot de passe',incorrect: 'Le mot de passe doit contenir au moins 8 caractères dont au moins une lettre majuscule, une lettre minuscule et un chiffre'},required:{empty:"Le champ est obligatoire",incorrect:"Valeur incorrecte"},notzero:{empty:"Veillez choisir une option",incorrect:"Valeur incorrecte"},integer:{empty:"Entrez un nombre entier",
incorrect:"Entrez un nombre entier"},"float":{empty:"Entrez un nombre décimal",incorrect:"Entrez un nombre décimal"},min:{empty:"Entrez plus",incorrect:"Entrez plus"},max:{empty:"Entrez moins",incorrect:"Entrez moins"},between:{empty:"Entrez entre {0}-{1}",incorrect:"Entrez entre {0}-{1}"},name:{empty:"S\'il vous plaît, entrez votre nom",incorrect:"Nom incorrect, 2 caractères minimum"},lastname:{empty:"S\'il vous plaît, entrez votre prénom",incorrect:"Prénom incorrect, 2 caractères minimum"},phone:{empty:"S\'il vous plaît, entrez votre numéro de téléphone",incorrect:"Format de téléphone incorrect"},
email:{empty:"S\'il vous plaît, entrez votre adresse e-mail",incorrect:"Adresse e-mail incorrecte"},length:{empty:"S\'il vous plaît, entrez au moins {0} caractères et au maximum {1}",incorrect:"Vous avez entré moins de {0} caractères et plus de {1}"},minlength:{empty:"S\'il vous plaît, entrez au moins {0} caractères",incorrect:"Vous avez entré moins de {0} caractères"},maxlength:{empty:"S\'il vous plaît, entrez au maximum {0} caractères",incorrect:"YVous avez entré plus de {0} caractères"},maxfilesize:{empty:"Sélectionnez un fichier",
incorrect:"Taille du fichier trop grande (min {0} Mb, max {1} Mb)"},fileextension:{empty:"Sélectionnez un fichier",incorrect:"Type de fichier incorrect"}}},rules:{password: function (value) {return new RegExp(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/gi).test(value);},required:function(a){return""!==a},notzero:function(a){return 0<parseInt(a,10)},integer:function(a){return(new RegExp(/^[0-9]+$/gi)).test(a)},"float":function(a){a=a.toString().replace(/,/,".");return this.integer(a)||(new RegExp(/^([0-9])+(\.)([0-9]+$)/gi)).test(a)},min:function(a,b){return this["float"](a)?parseFloat(a)>=parseFloat(b[0]):
