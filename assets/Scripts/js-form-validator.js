	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    en: {
		        ...
		        notzero: {
		            empty: 'Veillez choisir une option',
		            incorrect: 'Valeur incorrecte'
		        },
		        integer: {
		            empty: 'Entrez un nombre entier',
		            incorrect: 'Entrez un nombre entier'
		        },
		        float: {
		            empty: 'Entrez un nombre décimal',
		            incorrect: 'Entrez un nombre décimal'
		        },
		        min: {
		            empty: 'Entrez plus',
		        ...
		        between: {
		            empty: 'Entrez entre {0}-{1}',
		            incorrect: 'Entrez entre {0}-{1}'
		        },
		        name: {
		        ...
		        length: {
		            empty: 'S\'il vous plaît, entrez au moins {0} caractères et au maximum {1}',
		            incorrect: 'Vous avez entré moins de {0} caractères et plus de {1}'
		        },
		        minlength: {
		            empty: 'S\'il vous plaît, entrez au moins {0} caractères',
		            incorrect: 'Vous avez entré moins de {0} caractères'
		        },
		        maxlength: {
		            empty: 'S\'il vous plaît, entrez au maximum {0} caractères',
		        ...
		        fileextension: {
		            empty: 'Sélectionnez un fichier',
		            incorrect: 'Type de fichier incorrect'
		        }
		    }
		},
